...
export const AppRoutes = () => {
  ...
  return (
    <Routes>
      ...
      {/* reports */}
      <Route path="/reports/employees-hours" element={<ProtectedRoute element={<AssignedHoursPage />} />} /> 
      <Route path="/reports/monthly" element={<ProtectedRoute element={<MonthlyReportPage />} />} /> 
      <Route path="/reports/anual" element={<ProtectedRoute element={<AnnualReportPage />} />} /> 
