...
const UserRegisterForm = ({ onSubmit }) => {
    ...
    return (
        <div className="card shadow-lg border-0 p-4 col-lg-6 col-md-8 col-sm-10 m-auto">
            <form onSubmit={handleSubmit((formData) => onFinalSubmit(formData, resetForm))} noValidate>
                ...
                <div className="mb-4 position-relative">
                    ...
                    <div className="input-group">
                        ...
                        {errors.repeatPassword && <div className="invalid-feedback d-block">{errors.repeatPassword}</div>}
                    </div>
                </div>
